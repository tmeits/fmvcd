...
RZ<-mice(station.cli[c(5,6)], m=5, maxit=50, meth='pmm', seed=500)
summary(RZ)
compRZ1<-complete(RZ,1)
compRZ2<-complete(RZ,2)
compRZ3<-complete(RZ,3)
compRZ4<-complete(RZ,4)
compRZ5<-complete(RZ,5)
