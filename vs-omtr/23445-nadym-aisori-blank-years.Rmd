---
title: "aisori station: Missing Data"
author: IVA
...
grnn.prec.1959 <- grnn.prec(1959, 3, 2.6)
...
grnn.temp.1959 <- grnn.temp(1959, 1.3 ,2.3)
grnn.temp.1977 <- grnn.temp(1977, 1.5 ,2.0)
...
df.cli.site.period[df.cli.site.period$Year==1959, 8] <- grnn.prec.1959
df.cli.site.period[df.cli.site.period$Year==1977, 8] <- grnn.prec.1977

df.cli.site.period[df.cli.site.period$Year==1959, 6] <- grnn.temp.1959
...
for (i in min(df.cli.site.period$Year):max(df.cli.site.period$Year)){
  ...
  summary(df.vso.i)
  write.table.vso(df.vso.i, file.cli.path, paste0("/23445-nadym.cli/", i, ".CLI"))
}
