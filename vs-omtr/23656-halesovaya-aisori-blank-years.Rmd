---
title: "23656-halesovaya.txt aisori station: Missing Data"
author: IVA
...
file.name <- "/23656-halesovaya.txt"
...
grnn.prec.1957 <- grnn.prec(1957, 7, 1.6)
grnn.prec.1977 <- grnn.prec(1977, 5, 1.6)
grnn.prec.1993 <- grnn.prec(1993, 9, 2.6)
grnn.prec.1994 <- grnn.prec(1994, 3, 5.6)
grnn.prec.1995 <- grnn.prec(1995, 4, 2.6)
grnn.prec.1996 <- grnn.prec(1996, 3, 4.6)
...
grnn.temp.1957 <- grnn.temp(1957, 1.7 ,2.7)
grnn.temp.1977 <- grnn.temp(1977, 1.6 ,2.9)
grnn.temp.1993 <- grnn.temp(1993, 1.8 ,2.5)
grnn.temp.1994 <- grnn.temp(1994, 1.5 ,2.2)
grnn.temp.1995 <- grnn.temp(1995, 1.7 ,2.5)
grnn.temp.1996 <- grnn.temp(1996, 2.0 ,3.0)
...
df.cli.site.period[df.cli.site.period$Year==1993, 8] <- grnn.prec.1993
df.cli.site.period[df.cli.site.period$Year==1994, 8] <- grnn.prec.1994
df.cli.site.period[df.cli.site.period$Year==1995, 8] <- grnn.prec.1995
df.cli.site.period[df.cli.site.period$Year==1996, 8] <- grnn.prec.1996
...
df.cli.site.period[df.cli.site.period$Year==1993, 6] <- grnn.temp.1993
df.cli.site.period[df.cli.site.period$Year==1994, 6] <- grnn.temp.1994
df.cli.site.period[df.cli.site.period$Year==1995, 6] <- grnn.temp.1995
df.cli.site.period[df.cli.site.period$Year==1996, 6] <- grnn.temp.1996
...
for (i in min(df.cli.site.period$Year):max(df.cli.site.period$Year)){
  ...
  summary(df.vso.i)
  write.table.vso(df.vso.i, file.cli.path, paste0("/23656-halesovaya.cli/", i, ".CLI"))
}
