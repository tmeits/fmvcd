---
title: "23365-sidorovsk.txt aisori station: Missing Data"
author: IVA
...
#grnn.prec.1997 <- grnn.prec(1997, 3, 2.6)
...
#grnn.temp.1997 <- grnn.temp(1997, 1.3 ,2.3)
...
for (i in min(df.cli.site.period$Year):max(df.cli.site.period$Year)){
  ...
  summary(df.vso.i)
  write.table.vso(df.vso.i, file.cli.path, paste0("/23365-sidorovsk.cli/", i, ".CLI"))
}
