---
title: "23891-baikit.txt aisori station: Missing Data"
author: IVA
...
grnn.prec.1937 <- grnn.prec(1937, 7, 1.6)
...
grnn.temp.1937 <- grnn.temp(1937, 1.5 ,2.3)
...
df.cli.site.period[df.cli.site.period$Year==1937, 8] <- grnn.prec.1937


df.cli.site.period[df.cli.site.period$Year==1937, 6] <- grnn.temp.1937
...
for (i in min(df.cli.site.period$Year):max(df.cli.site.period$Year)){
  ...
  summary(df.vso.i)
  write.table.vso(df.vso.i, file.cli.path, paste0("/23891-baikit.cli/", i, ".CLI"))
}
