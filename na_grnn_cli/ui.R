...
shinyUI(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      actionButton("button", "Toggle numericInput"), actionButton("button2", "Toggle slider SIGMA"),
      ...
      downloadButton('downloadData', 'Download the table with filled passes', class = "butt"),
      tags$hr(),
    ...
    mainPanel(
      tabsetPanel( # http://rstudio.github.io/shiny/tutorial/#tabsets
        ...
        tabPanel("Prec NAs replaced", 
                 ...
                 sliderInput("sigmaPrecGRNN", label = "Changing the value of Sigma", 
                             min = 0.01, 
                             max = 0.9, value = 0.16),
                 numericInput('countTest', 'The size of the test sample', 69,
                              min = 21, max = 191),
        ...
        tabPanel("Temp NAs replaced", 
                 ...
                 #                             max = 0.9, value = 0.56)),
                 sliderInput("sigmaTempGRNN", label = "Changing the value of Sigma", 
                             min = 0.01, 
                                                          max = 0.9, value = 0.24),
                 numericInput('countTest', 'The size of the test sample', 69,
                              min = 21, max = 191),
